...
import { useRef, forwardRef, useState, memo, useCallback } from "react";
...
// Memoized Contact Links Component
...
// Memoized Download Resume Button
const DownloadResumeButton = memo(({ onClick }) => (
  <button
...
// Memoized Current Role Section
const CurrentRoleSection = memo(() => (
  <div
    className="relative group opacity-0 animate-slide-in"
      ...
      <div className="flex items-start space-x-6">
        ...
        <div className="flex-1">
          ...
          <p className="text-[rgb(117,78,249)] font-semibold text-lg mb-2">
            MERN Stack Developer at Seven Mentor Pvt. Ltd.
          </p>
...
CurrentRoleSection.displayName = 'CurrentRoleSection';
            ...
            <div className="sticky top-8">
              ...
              <div className="relative group">
                ...
                <div className="relative bg-gray-900/80 backdrop-blur-2xl border border-gray-800/50 rounded-3xl p-8 shadow-2xl">
                  ...
                  <ContactLinks />
                  <SocialLinks />
                  <DownloadResumeButton onClick={handleDownloadClick} />
                </div>
              </div>
            </div>
          </div>
